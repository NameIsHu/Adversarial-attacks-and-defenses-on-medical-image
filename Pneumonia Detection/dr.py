...
if __name__ == '__main__':
    ...
    model.eval()
    print("use densenet model for Pneumonia Detection")
    attacks = {}
    attacks["PGD"] = 1
    attacks["FGSM"] = 1
    attacks["CW"] = 1
    ...
    for attack_name, attack in attacks.items():
        test_path = ('./Adversarial Image/resnet/'+attack_name+'/testing/')
        ...
        for i in range(len(y_p_auc)):
            y_p_auc[i]=y_p_auc[i][1]
        ...
        print("test data num:", total, "Test auc after ", attack_name, " attack:", roc_auc_score(y_o_auc,y_p_auc),flush=True)
